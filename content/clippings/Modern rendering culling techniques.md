...
created: 2026-04-20
description: "🌲 The best work is the work that never gets executed"
tags:
  - "clippings"
---
...
- [Inside Quake: Visible Surface Determination](https://www.gamers.org/dEngine/quake/papers/ddjpvs.html)
- [Direct3D 12 query types](https://learn.microsoft.com/en-us/windows/win32/api/d3d12/ne-d3d12-d3d12_query_type)
...
- [ARM Hierarchical-Z Visibility Test sample](https://arm-software.github.io/opengl-es-sdk-for-android/occlusion_culling.html)
- [Masked Software Occlusion Culling](https://www.intel.com/content/www/us/en/developer/articles/technical/masked-software-occlusion-culling.html)
- [MaskedOcclusionCulling source code](https://github.com/GameTechDev/MaskedOcclusionCulling)
- [FidelityFX Single Pass Downsampler](https://gpuopen.com/manuals/fidelityfx_sdk/techniques/single-pass-downsampler/)
- [Direct3D 12 ExecuteIndirect sample](https://learn.microsoft.com/en-us/samples/microsoft/directx-graphics-samples/d3d12-execute-indirect-sample-win32/)
- [A Deep Dive into Nanite Virtualized Geometry (SIGGRAPH Advances 2021)](https://advances.realtimerendering.com/s2021/Karis_Nanite_SIGGRAPH_Advances_2021_final.pdf)
- [Clustered Deferred and Forward Shading](https://diglib.eg.org/items/6342d4d6-5220-4376-a5c6-a153058f4a3c)