---
title: "Voxel Engine in a Weekend"
source: "https://daymare.net/blogs/voxel-engine-in-a-weekend/"
author:
  - "[[Todaymare]]"
...
If you have any questions during the process feel free to reach out to me on [my discord server](https://discord.gg/t7gNX8Kp72) or contact me at [contact@daymare.net](https://daymare.net/blogs/voxel-engine-in-a-weekend/).
...
- [Hello, cube](https://daymare.net/blogs/voxel-engine-in-a-weekend/#hello-cube)
- [Meshes and Chunks](https://daymare.net/blogs/voxel-engine-in-a-weekend/#meshes-and-chunks)
- [World Generation](https://daymare.net/blogs/voxel-engine-in-a-weekend/#world-generation)
	- [Voxel Types](https://daymare.net/blogs/voxel-engine-in-a-weekend/#voxel-types)
- [Physics](https://daymare.net/blogs/voxel-engine-in-a-weekend/#physics)
	- [Raycasting](https://daymare.net/blogs/voxel-engine-in-a-weekend/#raycasting)
	- [AABB Collision](https://daymare.net/blogs/voxel-engine-in-a-weekend/#aabb-collision)
- [One last thing..](https://daymare.net/blogs/voxel-engine-in-a-weekend/#one-last-thing)
- [The End?](https://daymare.net/blogs/voxel-engine-in-a-weekend/#the-end)
- [..or is it?](https://daymare.net/blogs/voxel-engine-in-a-weekend/#or-is-it)
...
By the end of it you should roughly have a function `draw_cube` that takes in a `Vec3` position and draws a cube there. Here's mine:![A cube](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/draw-a-cube.png)
...
This should give us a one voxel tall 32x32 rectangle.![32x32 Platform](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/32x32-platform.png)
...
Now depending on what programming language you're using you might not be able to put `Vec3` in a HashSet. And even if you can, we should still be converting our float-based `Vec3` into an integer-based `IVec3` as that'll allow us to ensure that voxels are aligned to a grid. Which is important for foreshadowing reasons.
...
![](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/random-block.png)
...
so for, hopefully but not likely, the last time we finally have the same thing we had 15 minutes ago.![Different Angle](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/different-angle-lmao.png)
...
Whenever a new chunk is generated, we'll stuff it with some terrain. In this case that terrain is just "flat". It's not glamorous but hey, something something Rome wasn't built in a day and I did say this is going to take a weekend.
...
![Flat World Generation with Hole](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/flat-world-gen-with-hole.png)
...
![Flat World Generation without Hole](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/flat-world-gen-without-hole.png)
...
![Multiple Block Types](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/multiple-block-types.png)
...
![DDA Illustration](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/dda.png)
...
and now we can break blocks! We can do something similar for placing blocks as well, and this is where that last\_move value will be useful
...
![AABB Illustration](https://daymare.net/blogs/voxel-engine-in-a-weekend/assets/aabb.png)
...
In our create\_mesh function we were only drawing a face if the neighbour didn't exist (now it'd be if it's `VoxelKind::Air`) but since we were using a HashMap we didn't need to care if the neighbour was outside of our chunk.
...
And please please please show it off to me on [my discord server](https://discord.gg/t7gNX8Kp72) or contact me at [contact@daymare.net](https://daymare.net/blogs/voxel-engine-in-a-weekend/).
