---
title: Inigo Quilez
source: https://iquilezles.org/articles/fog/
author:
  - "[[Inigo Quilez - Better Fog]]"
published:
created: 2025-09-21
description: Tutorials and articles of Inigo Quilez on computer graphics, fractals, demoscene, shaders and more.
tags:
  - clippings
---
### Intro
...
![](https://iquilezles.org/articles/fog/gfx00.jpg)  
Without fog it's not easy to tell the scale of the terrain

![](https://iquilezles.org/articles/fog/gfx01.jpg)  
...
vec3 applyFog( in vec3 col, // color of pixel in float t ) // distance to point { float fogAmount = 1.0 - exp (-t\*b); vec3 fogColor = vec3 (0.5,0.6,0.7); return mix ( col, fogColor, fogAmount ); }
...
![](https://iquilezles.org/articles/fog/gfx02.jpg)  
Regular monocrhome fog

![](https://iquilezles.org/articles/fog/gfx03.jpg)  
...
![](https://iquilezles.org/articles/fog/gfx06.png)  
The integral of the fog density function d(y) over the ray gives the final amount of fog

  
  

![](https://iquilezles.org/articles/fog/gfx05.jpg)  
Note low altitude parts get extra fog

![](https://iquilezles.org/articles/fog/gfx04.jpg)  
...
![](https://iquilezles.org/articles/fog/gfx07.jpg)  
